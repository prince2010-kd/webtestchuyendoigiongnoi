    ...
    <tbody>
        @forelse ($comments as $comment)
            <tr>
                ...
                <td>
                    @if (!$comment->approved)
                        <form action="{{ route('admin.qlybluantintuc.comment.approve', $comment->id) }}" method="POST"
                    ...
                    <form action="{{ route('admin.qlybluantintuc.comment.unapprove', $comment->id) }}" method="POST"
                        style="display:inline-block">
                        @csrf

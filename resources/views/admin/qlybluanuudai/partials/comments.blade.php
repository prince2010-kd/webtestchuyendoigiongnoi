...
@section('content')
    <div class="container-xxl my-4 vh-100">
        <h4>Bình luận cho bài: <strong>{{ $uuDai->title }}</strong></h4>
        <div class="card p-2 pt-3">
            ...
            <form id="filterForm">
                <div class="row mb-4">
                    ...
                    <div class="col-md-2">
                        <button type="submit" class="btn btn-primary float-start btn-search" data-id="{{ $uuDai->id }}">Tìm kiếm</button>
                    </div>
            ...
            <div class="ajax-pagination-container" data-table="#post-data" data-pagination="#pagination-post">
                <div id="table-container">
                    @include('admin.qlybluanuudai.partials._tablecomments')
                </div>

...
@section('content')
    <div class="container-xxl my-4 vh-100">
        <h3>Danh sách đăng ký tư vấn</h3>
        <div class="card p-2 pt-3">
            ...
            <form id="filterForm">
                <div class="row mb-4">
                    ...
                    <div class="col-md-2">
                        <button type="submit" class="btn btn-primary btn-search w-100">Tìm kiếm</button>
                    </div>
                </div>
            </form>
            <span class="total-records text-muted">Tổng: {{ $totalRecords }} bản ghi</span>
            ...
            <div class="ajax-pagination-container" data-table="#post-data" data-pagination="#pagination-post">
                <div id="table-container" style="overflow-x: auto; width: 100%;">
                    @include('admin.dangkytuvan.partials._table')
                </div>

                <div class="mt-4 pagination" id="pagination-post">
                    @include('admin.component.pagination', ['posts' => $dangkytuvan])
                </div>
            </div>
        </div>
    </div>

    ...
    <div class="container-xxl my-4 vh-100">
        ...
        <div class="card p-2 pt-3">
            <div class="row mb-4">
                <div class="col-md-2 
                                    ">
                    <a href="{{ route('admin.question.create') }}" class="btn btn-primary mb-3">Thêm mới</a>
                </div>
            </div>
            ...
            <div class="ajax-pagination-container" data-table="#post-data" data-pagination="#pagination-post">
                <div id="table-container" style="overflow-x: auto; width: 100%;">
                    @include('admin.question.partials._table')
                </div>

                <div class="mt-4 pagination" id="pagination-post">
                    @include('admin.component.pagination', ['posts' => $questions])
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $('#delete-selected').click(function (e) {
            ...
            if (ids.length === 1) {
                ...
                url = '{{ route("admin.question.deleteMultiple") }}';
            }
